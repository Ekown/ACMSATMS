...
<nav class="green lighten-1">
    <div class="nav-wrapper">
      <form method="POST" action="/agent/search">
        <div class="input-field">
          <input id="search" placeholder="Input Tracking Number" type="search" name="acm_tracking_number" pattern="^[0-9]{5}$" title="Numbers only" required>
