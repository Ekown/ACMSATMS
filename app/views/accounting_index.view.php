	 	...
	 	<div class="row">
	 		<div class="col l4 push-l4 s12 m8 push-m2">
	             <div class="card blue-grey darken-1">
	                  ...
	                  <p><center><h5>Production Report</h4></center></p>
	                </div>
	             </div>
	        </div>
	    </div>
	</center>
  <form action="/accounting-in-charge/prodreport/result" method="POST">
		<!-- Sort By Dropdown -->
    <div class="container">
		<div class="row">
   ...
   <!-- ____________________Year Table_________________________ -->
	...
	<div id="year_results" hidden>
      ...
      <tbody>
	   ...
	   <div class="wrap">
        <a class="button green lighten-1" target="_blank" href="/accounting-in-charge/print/prodreport"><b>Print</b></a>
      </div>
     </div>
