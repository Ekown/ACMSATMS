...
<main>
	...
	<form action="/branch-manager/weekreport/result" method="POST">
	  <!-- Company Dropdown -->
	 <div class="row">
          ...
          <br>
          <div class="row">
          <div class="col l6 push-l2" id="search_button" hidden>
	...
	<div id="weekly_table" hidden>
      ...
      <br>
	   ...
	   <div class="wrap">
        <a class="button green lighten-1" target="_blank" href="/branch-manager/print/weekly-report"><b>Print</b></a>
      </div>
	 </div>
